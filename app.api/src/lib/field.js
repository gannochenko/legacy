...
import { DB_VARCHAR_DEF_LENGTH } from 'project-minimum-core';
import {
    TYPE_STRING,
    TYPE_BOOLEAN,
    TYPE_DATETIME,
    ...
    getFieldValidator() {
        if (!this.fieldValidator) {
            this.fieldValidator = {
                ...
                type: yup
                    .oneOf([yup.string(), yup.array().shape()])
                    .required('Field should have a type'),
                label: yup.string('Field label should be a string'),
