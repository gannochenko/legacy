...
var Schema = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, Promise.all(schema.map(function (entity) {
                    ...
                    case 1:
                        ...
                        this.getReferences().forEach(function (field) {
                            ...
                            if (!_this.getEntity(referenceName)) {
                                errors.push({
    ...
    Schema.prototype.getSafeDeclaration = function (declaration) {
        ...
        if (declaration.schema && microdash_1.default.isArray(declaration.schema)) {
            safeDeclaration.schema = declaration.schema.map(function (entity) { return new entity_1.Entity(entity); });
        }
    ...
    Schema.prototype.getEntity = function (name) {
        return this.declaration.schema.find(function (entity) { return entity.getName() === name; });
    };
