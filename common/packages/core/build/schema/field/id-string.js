...
var IdStringField = (function (_super) {
    ...
    IdStringField.prototype.getHealth = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, _super.prototype.getHealth.call(this)];
                    case 1:
                        errors = _a.sent();
                        name = this.getName();
                        ...
                        if (!unique) {
                            errors.push({
                                message: "System field \"" + constants_both_1.ENTITY_ID_FIELD_NAME + "\" should be unique",
                        ...
                        if (this.getActualType() !== field_type_1.FIELD_TYPE_STRING) {
                            errors.push({
                                message: "System field \"" + constants_both_1.ENTITY_ID_FIELD_NAME + "\" should be string",
                        ...
                        if (this.isMultiple()) {
                            errors.push({
                                message: "System field \"" + constants_both_1.ENTITY_ID_FIELD_NAME + "\" should not be multiple",
                                code: 'field_id_multiple',
                                fieldName: name,
                            });
                        }
                        if (length !== null && length !== constants_both_1.ENTITY_ID_FIELD_LENGTH) {
                            errors.push({
                                message: "System field \"" + constants_both_1.ENTITY_ID_FIELD_NAME + "\" should have length of " + constants_both_1.ENTITY_ID_FIELD_LENGTH,
    ...
    IdStringField.prototype.createValueItemValidator = function () {
        return yup
            .string()
            .length(constants_both_1.ENTITY_ID_FIELD_LENGTH, "Field '" + this.getDisplayName() + "' should be " + constants_both_1.ENTITY_ID_FIELD_LENGTH + " characters long")
