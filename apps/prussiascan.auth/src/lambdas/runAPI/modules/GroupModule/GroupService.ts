...
const TABLE_NAME = process.env.AWS_GROUP_TABLE_NAME ?? "";

@Injectable()
export class GroupService {
  constructor(private readonly optionsService: OptionsService) {}

  public async create(item: CreateInputType): Promise<CreateOutputType> {
    const { name } = item;
    ...
    try {
      ...
      console.error(error);
      throw new InternalServerErrorException("Could not create an object");
    }
