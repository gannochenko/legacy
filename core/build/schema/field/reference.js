...
/*#__PURE__*/
function (_BaseField) {
  _inherits(ReferenceField, _BaseField);

  function ReferenceField() {
    _classCallCheck(this, ReferenceField);

    return _possibleConstructorReturn(this, _getPrototypeOf(ReferenceField).apply(this, arguments));
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _get(_getPrototypeOf(ReferenceField.prototype), "getHealth", this).call(this);
    ...
    value: function castValue(value) {
      ...
      if (this.isMultiple()) {
        if (_lodash["default"].isArray(value)) {
          return _lodash["default"].unique(value.map(function (subValue) {
