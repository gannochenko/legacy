...
var Entity = (function () {
    ...
    Entity.prototype.getSafeDeclaration = function (declaration) {
        ...
        if (declaration.schema && microdash_1.default.isArrayNotEmpty(declaration.schema)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, Promise.all(declaration.schema.map(function (field) {
    ...
    Entity.prototype.getReferences = function () {
        return this.getFields().filter(function (field) { return field.isReference(); });
    };
    Entity.prototype.getSingleReferences = function () {
        return this.getFields().filter(function (field) { return field.isReference() && !field.isMultiple(); });
    };
    Entity.prototype.getMultipleReferences = function () {
        return this.getFields().filter(function (field) { return field.isReference() && field.isMultiple(); });
    };
    Entity.prototype.getField = function (name) {
        return this.declaration.schema.find(function (field) { return field.getName() === name; });
    };
    ...
    Entity.prototype.getPreviewField = function () {
        var preview = this.declaration.schema.find(function (field) {
            return field.getType() === field_type_1.FIELD_TYPE_STRING &&
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.getValidator().validate(sourceData, {
                                abortEarly: false,
                            })];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        ...
                        if (microdash_1.default.isArray(validationErrors_1.inner)) {
                            errors = validationErrors_1.inner.map(function (error) { return ({
