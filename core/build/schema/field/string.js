...
var _constants = require("../../constants.server");
...
/*#__PURE__*/
function (_BaseField) {
  _inherits(StringField, _BaseField);

  function StringField() {
    _classCallCheck(this, StringField);

    return _possibleConstructorReturn(this, _getPrototypeOf(StringField).apply(this, arguments));
  }

  _createClass(StringField, [{
    key: "getLength",
    value: function getLength() {
      var length = parseInt(this.declaration.length, 10);

      if (Number.isNaN(length)) {
        return _constants.DB_VARCHAR_DEF_LENGTH;
      }
